            ...
            <html>
                <body style="font-family: Arial, sans-serif;">
                    <div style="background-color: #f0f0f0; padding: 20px; border-radius: 10px;">
                        <h2 style="color: #2c5aa0;">📧 Study Assistant System</h2>
                        <div style="background-color: white; padding: 15px; border-radius: 5px; margin-top: 10px;">
                            <p style="line-height: 1.6;">{formatted_message}</p>
                        </div>
                        <hr style="margin: 20px 0; border: 1px solid #ddd;">
                        <p style="color: #666; font-size: 12px;">
                            🎓 Sent from Study Assistant System<br>
                            📅 {timestamp}
                        </p>
                    </div>
                </body>
...
4. Exam focus areas"""
    ...
    def generate_mock_exam(self, course_code):
        ...
        prompt = f"""Create a university mock exam in ENGLISH using EXACT same format as previous exams.
...
8. Make sure each exercise has the same point value as in the original format"""
        ...
        messages = [{"role": "user", "content": prompt}]
        exam = self.claude_request(messages, "You are a university professor creating an authentic exam.")
...
8. Make sure each exercise has the same point value as in the original format"""
    ...
    def create_exam_pdf(self, course_code, course_name, content, format_info):
        try:
            ...
            story.append(Paragraph("University", header_style))
...
Generated by Study Assistant System
...
def main():
    """CLI Interface for Study Assistant System"""
    print("\n╔══════════════════════════════════════════════════════════════════╗")
    print("║  🎓 STUDY ASSISTANT - UNIVERSAL SYSTEM                       ║")
